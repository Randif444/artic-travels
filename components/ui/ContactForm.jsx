...
export default function ContactForm() {
  ...
  return (
    <section id="contact" className="bg-slate-100 py-20 px-6 md:px-12">
      {}
      <div className="md:max-w-5xl max-w-4xl md:mx-0 mx-auto">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Input Name - Dibungkus div flex-col menggantikan <br/> */}
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                // Dihapus h-10 nya, biarkan py-3 yang menentukan tinggi. Ditambah focus state.
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              // Diubah jadi h-32 biar agak luas buat ngetik cerita panjang
